...
export const DEFAULT_STORAGE_ROOT_ID = "pockets-root";
export const DEFAULT_SLOT_COUNT = 8;
export const DEFAULT_STACK_SIZE = 8;
export const BAG_SLOT_COUNT = 8;

export const TOOL_DEFINITIONS = Object.freeze({
  [DEFAULT_STORAGE_ROOT_ID]: createTool({
    id: DEFAULT_STORAGE_ROOT_ID,
    label: "Pockets",
    category: "storage-root",
    branchId: "storage-root",
    branchLabel: "Pockets",
    price: 0,
    miningPower: 0,
    description: "Your starting carry space: 8 slots with stacks of 8 per slot.",
    tier: 0,
  ...
  "capacity-1": createTool({
    id: "capacity-1",
    label: "Roomier Pockets",
    category: "capacity",
    branchId: "capacity",
    branchLabel: "Larger Pockets & Bags",
    price: 24,
    miningPower: 0,
